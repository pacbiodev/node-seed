...
declare module "jsonwebtoken" {
    ...
    function verify(token: string, secretOrPublicKey: string, options?: VerifyOptions, callback?: 
VerifyCallbak): any;
    function verify(token: string, secretOrPublicKey: Buffer, options?: VerifyOptions, callback?: 
VerifyCallbak): void;
